...
block13 = Block(1, np.array[10.8, 8.1, 1], np.array([12.3, 8.1, 1]), 0.5) # it is a stair
...
intersectionb = Intersection(np.array([8.5, 3.4, 1]), [block1, block3], 0.4)  # stairs
...
intersectiong = Intersection(np.array([17.8, 3.35, 1]), [block9, block10], 0.5)
