...
# floor0
blocka = Block(0, np.array([3.7, 3, 0]), np.array([5.3, 3, 0]), 0.8)
blockb = Block(0, np.array([8.5, 2.4, 0]), np.array([8.5, 3.2, 0]), 0.4)
blockc = Block(0, np.array([8.7, 3.4, 0]), np.array([10.2, 3.4, 0]), 0.4)
blockd = Block(0, np.array([10.4, 2.4, 0]), np.array([10.4, 3.2, 0]), 0.4)
...
blocki = Block(0, np.array([14.55, 3.6, 0]), np.array([14.55, 4.4, 0]), 0.3)
blockj = Block(0, np.array([14.55, 5.2, 0]), np.array([14.55, 8.35, 0]), 0.5)
...
blocko = Block(0, np.array([8.55, 9.35, 0]), np.array([8.55, 8.35, 0]), 0.5)
# floor1
blockp = Block(1, np.array([3.7, 2.2, 1]), np.array([8.3, 2.2, 1]), 0.4)
blockq = Block(1, np.array([8.5, 2.4, 1]), np.array([8.5, 3.2, 1]), 0.4)
blockr = Block(1, np.array([8.7, 3.4, 1]), np.array([10.2, 3.4, 1]), 0.4)
blocks = Block(1, np.array([8.7, 2.2, 1]), np.array([10.2, 2.2, 1]), 0.4)
blockt = Block(1, np.array([10.4, 2.4, 1]), np.array([10.4, 3.2, 1]), 0.4)
...
blocky = Block(1, np.array([17.8, 3.6, 1]), np.array([17.8, 6.6, 1]), 0.4)
...
blockaf = Block(1, np.array([8.55, 9.35, 1]), np.array([8.55, 8.35, 1]), 0.5)
...
blockas = Block(-1, np.array([14.55, 3.6, -1]), np.array([14.55, 4.4, -1]), 0.5)
blockat = Block(-1, np.array([14.95, 4.8, -1]), np.array([16, 4.8, -1]), 0.8)
blockau = Block(-1, np.array([8.7, 3.4, -1]), np.array([10.2, 3.4, -1]), 0.4)
blockav = Block(-1, np.array([8.5, 2.4, -1]), np.array([8.5, 3.2, -1]), 0.4)
blockaw = Block(-1, np.array([10.4, 2.4, -1]), np.array([10.4, 3.2, -1]), 0.4)
...
# block for floor 2
blockbg = Block(2, np.array([8.55, 9.35, 2]), np.array([8.55, 8.35, 2]), 0.5)
...
blockbm = Block(2, np.array([14.55, 5.2, 2]), np.array([14.55, 8.35, 2]), 0.4)
blockbn = Block(2, np.array([14.55, 3.6, 2]), np.array([14.55, 4.4, 2]), 0.3)
...
blockaj = Block(0.5, np.array([17.55, 3.35, 1]), np.array([18.05, 3.35, 0]), 0.2)
# stair in inter23 and 9
blockak = Block(0.5, np.array([10.3, 9.6, 1]), np.array([10.8, 9.6, 0]), 0.2)
# stair in inter27 and 7
blockal = Block(0.5, np.array([14.15, 4.8, 1]), np.array([14.95, 4.8, 0]), 0.2)
...
intersection6 = Intersection(np.array([17.8, 6.85, 0]), [blockh, blockan], 0.5)
...
intersection12 = Intersection(np.array([8.55, 8.1, 0]), [blockn, blocko], 0.5)

# floor 1
intersection15 = Intersection(np.array([8.5, 2.2, 1]), [blockp, blockq, blocks], 0.4)
...
intersection18 = Intersection(np.array([10.4, 2.2, 1]), [blocks, blockt, blockv], 0.4)
intersection19 = Intersection(np.array([13, 2.9, 1]), [blocku, blockv, blockw, blockai], 1.8)  # stairs
intersection20 = Intersection(np.array([14.55, 3.35, 1]), [blockw, blockx, blockz], 0.5)
intersection21 = Intersection(np.array([17.8, 3.35, 1]), [blockx, blocky, blockaj, blockbt], 0.5)  # stairs
...
intersection25 = Intersection(np.array([8.55, 8.1, 1]), [blockad, blockaf], 0.5)
...
intersection28 = Intersection(np.array([3.5, 2.2, 1]), [blockp, blockam], 0.4)  # stairs
intersection29 = Intersection(np.array([17.8, 6.85, 1]), [blocky, blockan], 0.5)  # stairs

# floor 2
intersection37 = Intersection(np.array([8.55, 9.6, 2]), [blockbh, blockbg], 0.5)
intersection38 = Intersection(np.array([8.55, 8.1, 2]), [blockbg, blockbi], 0.5)
...
intersection44 = Intersection(np.array([17.8, 3.35, 2]), [blockbo, blockbp, blockbt], 0.5)
